...
const Contato = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    window.open(`https://wa.me/5591984832468?text=${encodeURIComponent(msg)}`, "_blank");
      ...
      <section className="section-padding" style={{ background: "var(--hero-gradient)" }}>
        <div className="container text-center">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            Tire suas dúvidas e agende uma aula experimental com a Tia Ceci.
          </p>
        </div>
      </section>
            ...
            <div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <Input id="telefone" value={form.telefone} onChange={(e) => setForm({ ...form, telefone: e.target.value })} placeholder="(91) 00000-0000" maxLength={20} />
                </div>
                <div>
              ...
              <div className="space-y-6">
                <a href={WHATSAPP_URL} target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 p-4 rounded-xl bg-whatsapp/10 hover:bg-whatsapp/20 transition-colors">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">(91) 98483-2468</p>
                  </div>
                </a>
                ...
                <a href="https://instagram.com/pedagoga.cecilya" target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 p-4 rounded-xl bg-muted hover:bg-muted/80 transition-colors">
                  <div className="w-12 h-12 rounded-full bg-primary/10 flex items-center justify-center">
                    <Instagram className="w-6 h-6 text-primary" />
                  </div>
                  <div>
                    <p className="font-semibold text-foreground">Instagram</p>
                    <p className="text-sm text-muted-foreground">@pedagoga.cecilya</p>
                  </div>
                </a>
                <div className="flex items-center gap-4 p-4 rounded-xl bg-muted">
                  <div className="w-12 h-12 rounded-full bg-primary/10 flex items-center justify-center">
